...
<body>
    ...
    <div class="container">
        ...
        <div class="table-responsive">
            <form action="http://webdev.local/vnpay_php/vnpay_create_payment.php" id="create_form" method="post">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" id="order_id" name="order_id" type="text"
                        value="<?php echo isset($order_id) ? $order_id : '' ?>" readonly />
                </div>
                <div class="form-group">
                    <label for="amount">Số tiền</label>
                    <input class="form-control" id="amount" name="amount" type="number" value="<?= $total_money ?>"
                        readonly />
                </div>
                <div class="form-group">
